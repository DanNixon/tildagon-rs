use super::{
    interface::{I2cAddr, I2cInterface, ReadData, WriteData},
    registers::Registers,
    types::{
        AccConf, AccOffsets, AccRange, AccSelfTest, AuxConf, AuxData, AuxIfConf, AxisData,
        BMI160_CHIP_ID, BMI260_CHIP_ID, BMI270_CHIP_ID, Burst, Cmd, Data, Drv, Error, ErrorReg,
        ErrorRegMsk, Event, FIFO_LENGTH_1_MASK, FifoConf, FifoDowns, GyrConf, GyrCrtConf,
        ...
        Saturation, Status, WristGestureActivity,
    },
};
